...
function u492.NewWindow(_, _, p508, p509)
    ...
    _TextLabel.Text = "TSUO HUB<font color='rgb(128,0,128)'> KING LEGACY</font>"
...
local _Settings = _ConfigsFarm:AddSection('Settings', 'Script Made By jay#0050', 'Join Tsuo Hub Discord For Updates! \nuse at your own risk.', 'http://www.roblox.com/asset/?id=6031233840')
...
_Settings:Slider('Hold Z', 0, 100, u458.Z, function(p1175)
    u458.Z = p1175

    SaveSettings()
end)
_Settings:Slider('Hold X', 0, 100, u458.X, function(p1176)
    u458.X = p1176

    SaveSettings()
end)
_Settings:Slider('Hold C', 0, 100, u458.C, function(p1177)
    u458.C = p1177

    SaveSettings()
end)
_Settings:Slider('Hold V', 0, 100, u458.V, function(p1178)
    u458.V = p1178

    SaveSettings()
end)
_Settings:Slider('Hold B', 0, 100, u458.B, function(p1179)
    u458.B = p1179

    SaveSettings()
end)
_Settings:Slider('Hold E', 0, 100, u458.E, function(p1180)
    u458.E = p1180
